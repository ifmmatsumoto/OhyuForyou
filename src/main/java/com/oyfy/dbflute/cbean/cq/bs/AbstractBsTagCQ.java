...
/**
 * The abstract condition-query of tag.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTagCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTagCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<TagCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TagCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TagCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TagCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TagCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TagCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TagCB&gt;() {
     *     public void query(TagCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TagCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TagCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TagCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TagCQ sq);

    protected TagCB xcreateScalarConditionCB() {
        TagCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TagCB newMyCB() {
        return new TagCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TagCQ.class.getName(); }
