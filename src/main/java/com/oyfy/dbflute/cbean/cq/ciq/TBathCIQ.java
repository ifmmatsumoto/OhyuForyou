...
/**
 * The condition-query for in-line of t_bath.
 * @author DBFlute(AutoGenerator)
 */
public class TBathCIQ extends AbstractBsTBathCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBathCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBathCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBathCQ myCQ) {
    ...
    public String keepScalarCondition(TBathCQ sq)
    ...
    protected String xinCB() { return TBathCB.class.getName(); }
    protected String xinCQ() { return TBathCQ.class.getName(); }
}
