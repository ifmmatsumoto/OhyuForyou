...
import com.oyfy.dbflute.cbean.cq.bs.BsTagCQ;

/**
 * The condition-query of tag.
 * <p>
 ...
 */
public class TagCQ extends BsTagCQ {
     ...
     */
    public TagCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
