...
/**
 * The condition-query for in-line of tag.
 * @author DBFlute(AutoGenerator)
 */
public class TagCIQ extends AbstractBsTagCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTagCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TagCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTagCQ myCQ) {
    ...
    protected String xinCB() { return TagCB.class.getName(); }
    protected String xinCQ() { return TagCQ.class.getName(); }
}
