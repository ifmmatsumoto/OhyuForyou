...
/**
 * The base condition-bean of t_bath.
 * @author DBFlute(AutoGenerator)
 */
public class BsTBathCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TBathCQ _conditionQuery;
     ...
     */
    public TBathCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TBathCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TBathCQ doGetConditionQuery() {
    ...
    protected TBathCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TBathCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TBathCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TBathCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TBathCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TBathCB> unionCBLambda) {
        final TBathCB cb = new TBathCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TBathCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TBathCB> unionCBLambda) {
        final TBathCB cb = new TBathCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TBathCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TBathCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TBathCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "t_bath"; }
    }
     ...
     */
    public TBathCB dreamCruiseCB() {
        TBathCB cb = new TBathCB();
        cb.xsetupForDreamCruise((TBathCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TBathCB> columnQuery(final SpecifyQuery<TBathCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TBathCB xcreateColumnQueryCB() {
        TBathCB cb = new TBathCB();
        cb.xsetupForColumnQuery((TBathCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TBathCB> orCBLambda) {
        xorSQ((TBathCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TBathCB> andCBLambda) {
        xorSQAP((TBathCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TBathCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TBathCQ.class.getName(); }
