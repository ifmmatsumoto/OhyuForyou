...
/**
 * The entity of t_tag as TABLE. <br>
 * �^�O
 * <pre>
 * [primary-key]
 *     
 ...
 */
public abstract class BsTTag extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTag) {
            BsTTag other = (BsTTag)obj;
