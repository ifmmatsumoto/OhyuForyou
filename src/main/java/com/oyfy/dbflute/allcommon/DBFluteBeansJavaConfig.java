 ...
 */
@Configuration
@ComponentScan(value="com.oyfy.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.oyfy.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.oyfy.dbflute.allcommon.ImplementedInvokerAssistant();
    }
