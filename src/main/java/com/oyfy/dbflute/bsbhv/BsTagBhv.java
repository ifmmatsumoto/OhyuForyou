...
public abstract class BsTagBhv extends AbstractBehaviorWritable<Tag, TagCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public TagDbm asDBMeta() { return TagDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "tag"; }

    // ===================================================================================
    //                                                                        New Instance
    //                                                                        ============
    /** {@inheritDoc} */
    public TagCB newConditionBean() { return new TagCB(); }
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public int selectCount(CBCall<TagCB> cbLambda) {
     ...
     * <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">tag</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = <span style="color: #553000">tag</span>.get...
     * });
     *
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">tag</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OptionalEntity<Tag> selectEntity(CBCall<TagCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<Tag> facadeSelectEntity(TagCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends Tag> OptionalEntity<ENTITY> doSelectOptionalEntity(TagCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * Tag <span style="color: #553000">tag</span> = <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">tag</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of Tag. (NotNull)
     ...
     * <pre>
     * ListResultBean&lt;Tag&gt; <span style="color: #553000">tagList</span> = <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (Tag <span style="color: #553000">tag</span> : <span style="color: #553000">tagList</span>) {
     *     ... = <span style="color: #553000">tag</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of Tag. (NotNull)
     ...
     */
    public ListResultBean<Tag> selectList(CBCall<TagCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;Tag&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (Tag tag : <span style="color: #553000">page</span>) {
     *     ... = tag.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of Tag. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<Tag> selectPage(CBCall<TagCB> cbLambda) {
     ...
     * <pre>
     * <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of Tag. (NotNull)
     * @param entityLambda The handler of entity row of Tag. (NotNull)
     */
    public void selectCursor(CBCall<TagCB> cbLambda, EntityRowHandler<Tag> entityLambda) {
     ...
     * <pre>
     * <span style="color: #0000C0">tagBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<TagCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * @param tagList The entity list of tag. (NotNull)
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(List<Tag> tagList, ReferrerLoaderHandler<LoaderOfTag> loaderLambda) {
        xassLRArg(tagList, loaderLambda);
        loaderLambda.handle(new LoaderOfTag().ready(tagList, _behaviorSelector));
    }
     ...
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has order by FK before callback.
     * @param tag The entity of tag. (NotNull)
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(Tag tag, ReferrerLoaderHandler<LoaderOfTag> loaderLambda) {
        xassLRArg(tag, loaderLambda);
        loaderLambda.handle(new LoaderOfTag().ready(xnewLRAryLs(tag), _behaviorSelector));
    }
     ...
     * tagBhv.outideSql().selectEntity(pmb); <span style="color: #3F7E5E">// optional</span>
     * tagBhv.outideSql().selectList(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * tagBhv.outideSql().selectPage(pmb); <span style="color: #3F7E5E">// PagingResultBean</span>
     * tagBhv.outideSql().selectPagedListOnly(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * tagBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     * tagBhv.outideSql().execute(pmb); <span style="color: #3F7E5E">// int (updated count)</span>
     * tagBhv.outideSql().call(pmb); <span style="color: #3F7E5E">// void (pmb has OUT parameters)</span>
     *
     * <span style="color: #3F7E5E">// traditional style</span>
     * tagBhv.outideSql().traditionalStyle().selectEntity(path, pmb, entityType);
     * tagBhv.outideSql().traditionalStyle().selectList(path, pmb, entityType);
     * tagBhv.outideSql().traditionalStyle().selectPage(path, pmb, entityType);
     * tagBhv.outideSql().traditionalStyle().selectPagedListOnly(path, pmb, entityType);
     * tagBhv.outideSql().traditionalStyle().selectCursor(path, pmb, handler);
     * tagBhv.outideSql().traditionalStyle().execute(path, pmb);
     *
     * <span style="color: #3F7E5E">// options</span>
     * tagBhv.outideSql().removeBlockComment().selectList()
     * tagBhv.outideSql().removeLineComment().selectList()
     * tagBhv.outideSql().formatSql().selectList()
     * </pre>
     * <p>The invoker of behavior command should be not null when you call this method.</p>
     * @return The new-created all facade executor of outside-SQL. (NotNull)
     */
    public OutsideSqlAllFacadeExecutor<TagBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends Tag> typeOfSelectedEntity() { return Tag.class; }
    protected Class<Tag> typeOfHandlingEntity() { return Tag.class; }
    protected Class<TagCB> typeOfHandlingConditionBean() { return TagCB.class; }
